...
import { DeliveryConfigForm } from '@/modules/settings/components/delivery-config-form';
import { ReceiptConfigForm } from '@/modules/settings/components/receipt-config-form';
import { KdsConfigForm } from '@/modules/settings/components/kds-config-form';
    ...
    <div className="space-y-6" data-page="location-edit" data-id={id}>
      ...
      <Tabs defaultValue="basic">
        ...
        <TabsContent value="delivery" className="mt-6">
          <DeliveryConfigForm locationId={id} />
        </TabsContent>

        <TabsContent value="receipt" className="mt-6">
          <ReceiptConfigForm locationId={id} />
        </TabsContent>

        <TabsContent value="kds" className="mt-6">
          <KdsConfigForm locationId={id} />
        </TabsContent>
      </Tabs>
    </div>
  );
