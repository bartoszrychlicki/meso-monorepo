...
export const recipes: Recipe[] = [
  ...
  // Cheeseburger
  {
    ...
    ingredients: [
      ...
      {
        id: crypto.randomUUID(),
        stock_item_id: STOCK_ITEM_IDS.ONION,
        quantity: 30,
        unit: 'g',
  ...
  // Truffle Burger
  {
    ...
    ingredients: [
      ...
      {
        id: crypto.randomUUID(),
        stock_item_id: STOCK_ITEM_IDS.BUTTER,
        quantity: 20,
        unit: 'g',
  ...
  // Classic Fries
  {
    ...
    ingredients: [
      {
        id: crypto.randomUUID(),
        stock_item_id: STOCK_ITEM_IDS.POTATOES,
        quantity: 250,
        unit: 'g',
  ...
  // Lemonade
  {
    ...
    ingredients: [
      {
        id: crypto.randomUUID(),
        stock_item_id: STOCK_ITEM_IDS.LEMONS,
        quantity: 2,
        unit: 'szt',
      ...
      {
        id: crypto.randomUUID(),
        stock_item_id: STOCK_ITEM_IDS.WATER,
        quantity: 1,
        unit: 'szt',
  ...
  // Brownie
  {
    ...
    ingredients: [
      {
        id: crypto.randomUUID(),
        stock_item_id: STOCK_ITEM_IDS.CHOCOLATE,
        quantity: 80,
        unit: 'g',
  ...
  // Ice Cream
  {
    ...
    ingredients: [
      {
        id: crypto.randomUUID(),
        stock_item_id: STOCK_ITEM_IDS.ICE_CREAM,
        quantity: 150,
        unit: 'ml',
